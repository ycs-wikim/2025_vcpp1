...
///lParam을 전역 변수로 선언한 경우의 코드
/*
LPARAM g_lParam;

/// 스레드 함수 형식
DWORD       /// 반환 값 : 숫자 반환이 필수
WINAPI      /// API 형식에서 사용될 것이다.
pig(LPVOID param)
{
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
        /// 스레드 처리 코드
        /// 마우스 왼쪽 클릭 메시지가 오자마자 전역 변수에 보관!
        //g_lParam = lParam;
        g_hWnd = hWnd;
        g_th[g_cnt++] = CreateThread(NULL, 0, pig, (LPVOID)lParam, 0, NULL);
